...
<body style="background-color:black;">
    ...
    <class class="welcome">
        <h2>
            <img src="icons/th1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="icons/th2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button style="background-color:yellowgreen" type="button" class="btn btn-dark btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>

 <!-- Table -->
 <div class="container">
        <h2 class="text-center pt-4" style="color : whitesmoke;">Customer Details</h2>
            <?php
                include 'connect.php';
                $sid=$_GET['id'];
        ...
        <h2 class="text-center pt-4" style="color : whitesmoke;">Transer Money Here !</h2>
        <label style="color : wheat;"><strong>Transfer To:</strong></label>
        ...
        <br>
        <br>
            <label style="color : wheat;"><strong>Amount:</strong></label>
            <input type="number" class="form-control" name="amount" required>   
            <br><br>
                <div class="text-center" >
                <button style="background-color:yellowgreen" class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" >Fill the Amount and Transfer</button>
            </div>
        </form>
    </div>    
