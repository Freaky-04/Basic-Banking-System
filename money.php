...
<body style="background-color:#121212;">
    ...
    <class class="welcome">
        <h2>
            <img src="icons/mt1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong style="color:white">Money
                Transfer</strong> <img src="icons/mt2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>

    <!-- options -->
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        <a href="history.php"><button  style="background-color:yellowgreen" type="button" class="btn btn-primary btn-lg mb-3">See all Transaction History</button></a>
    </div>
    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : ghostwhite;">
                                    ...
                                    <td><a href="users.php?id= <?php echo $rows['id']; ?>"> <button style="background-color:ghostwhite" class="btn btn-outline-dark btn">View and Transact</button></a></td>
                                </tr>
                            <?php
                            }
                            ?>
